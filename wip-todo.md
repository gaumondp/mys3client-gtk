...
- [x] **Drag and Drop:**
  - [x] Implement drag-and-drop from the OS to the file list for uploads.
  - [ ] Implement drag-and-drop from the file list to the OS for downloads.
- [x] **Context Menus:** Add right-click context menus to the bucket/folder tree and the file list for quick access to CRUD operations.
